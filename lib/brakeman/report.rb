...
class Brakeman::Report
  ...
  VALID_FORMATS = [:to_html, :to_pdf, :to_csv, :to_json, :to_tabs, :to_hash, :to_s, :to_markdown, :to_codeclimate, :to_plain, :to_checkstyle]
  ...
  def format format
    ...
    when :to_checkstyle
      require_report 'checkstyle'
      Brakeman::Report::Checkstyle
    when :to_codeclimate
